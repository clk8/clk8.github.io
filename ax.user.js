      ...
      CanvasRenderingContext2D.prototype.stroke = function() {
          ...
          this.shadowBlur = 3; // remove this line for no blur
      };
      ...
      const html = '<main class="menu--holder"><main class="menu--body"><passive id="menu--title">Menu</passive><main class="menu--inner-gui"><passive class="menu--inner-gui-block"><passive id="menu--inner-gui-block-text">Quadratic heal mode <input type="checkbox" id="quadra">          Disable rotations <input type = "checkbox" id = "rotate"><br>Katana<input type = "checkbox" id = "katana">Musket<input type = "checkbox" id = "musket"><br>Auto mills<input type = "checkbox" id = "autoMill">360 spike on hit<input type = "checkbox" id = "spikeh"><br>Spam chat<input type = "checkbox" id = "spam"><input type = "name" id = "spamChat">Linear heal mode <input type="checkbox" id="lin"><br>Clowned heal mode <input type="checkbox" id="clown">Stupid heal mode <input type="checkbox" id="stupid"><br>360 Hit <input type="checkbox" id="hit360">AutoRespawn <input type = "checkbox" id = "autorespawn"><br></passive></passive></main></main></main>';
      setInterval(()=>{
      ...
      css = `
      <style>
      main.menu--holder {position: ${menu.position.absolute};top: ${menu.position.top};
